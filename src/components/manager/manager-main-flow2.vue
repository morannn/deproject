...
<!--      <div>eee</div>-->
<!--      <div class="board-left " v-for="item in boxmaxList" :key="value.id">-->
<!--        <el-card shadow="hover">-->
<!--          <div class="center">-->
<!--            <div>eeeee</div>-->
<!--            <h1>{{ item }} </h1>-->
<!--&lt;!&ndash;            <span class="el-dropdown-link" @click="delwork(value.id)"><i class="el-icon-close"&ndash;&gt;-->
<!--&lt;!&ndash;                style="margin-top: 0.4rem;"></i></span>&ndash;&gt;-->
<!--          </div>-->
<!--        </el-card>-->
<!--        &lt;!&ndash; 卡片内容处 &ndash;&gt;-->
...
export default {
  ...
  methods: {
    ...
    async Port_calls() {
      ...
      const {
        data: restop
      } = await reques.get("/matter/allmatters");
      console.log("eeeee")
      console.log(restop)
      ...
      for (let index = 0; index < this._List.length; index++) {
        const {
          data: resbom
        } = await reques.get("/matter/getById/" + this._List[index]);
        // 将数据获取到的存在arr数组里面
